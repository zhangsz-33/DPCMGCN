...
def parse_args():
    ...
    # parser.add_argument('--data_dir', type=str, default="F:/Data/SEU/gearset", help='the directory of the data')
    ...
    parser.add_argument('--lr_scheduler', type=str, choices=['step', 'exp', 'stepLR', 'fix', 'reduce'], default='step', help='the learning rate schedule')
