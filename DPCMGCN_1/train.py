...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='F:\Data\JNU\数据', help='the directory of the data')
    ...
    # MK-MMD--DAN    JMMD--JAN    CORAL--CORAL
    parser.add_argument('--distance_loss', type=str, choices=['MK-MMD', 'JMMD', 'CORAL', 'LMMD'], default='MK-MMD', help='which distance loss you use')
